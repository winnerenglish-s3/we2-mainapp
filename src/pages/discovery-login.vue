<template>
  <div style="height:100vh" class="bgDiscovery flex flex-center">
    <transition
      appear
    ...
    >
      <div>
        <div class align="center">
          <div class="q-py-md">
            <img src="../../public/images/dis-name.png" alt />
          </div>
          <div class="relative-position">
            <img src="../../public/images/dis-login.png" alt />
            <div style="width:270px" class="absolute-center">
              ...
              <!-- ปุ่มเข้าสู่ระบบ -->
              <div class="q-mt-md">
                <div @click="toDiscovery()" class="btn-login relative-position">
                  <span class="absolute-center">เข้าสู่ระบบ</span>
                </div>
              </div>
              <!-- ลืมรหัสผู้ใช้งาน -->
              <div class="forgotPassword q-pt-md">
                <div>ลืมรหัสผู้ใช้งานหรือรหัสผ่าน</div>
                <div>ติดต่อทีมงานได้ที่ LineID: winnerenglish</div>
              </div>
              <!-- สมัครใช้งาน -->
              <div class="q-py-md q-pb-lg">
                <u class="cursor-pointer" style="color:#5A2BBC">สมัครใช้งาน</u>
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    toDiscovery() {
      ...
      if (this.data.user == "admin" && this.data.password == "1234") {
        ...
        } else if (config.includes("firstentry")) {
