<template>
  <q-page class="bg-translation">
    ...
    <div class="box-container-main row relative-position">
      ...
      <div class="col-6 box-content-answer q-pt-md">
        <div class="q-mt-xl q-pa-lg">
          <div class="box-question q-pa-md">
            <span class="f16">
              จอห์นรักที่จะวาดรูปโบสถ์และอาคารสูงๆเมื่อเขาโตขึ้น เขาต้องการ
              ที่จะเป็นสถาปนิก
            </span>
          </div>
