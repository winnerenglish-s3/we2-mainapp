          ...
          <div>
            ...
            <div class=" relative-position" style="margin:30px 0px;">
              <q-img
                ...
                style="width:120px;"
              >
                <div class="font-level absolute-center">
                  LV.7
                </div>
                <div class="font-level-shadow absolute-center bg-transparent">
                  LV.7
                </div>
              </q-img>
            </div>
            ...
            <div class=" q-mt-xl">
              <span class="font-brown">
                ไม่ต้องกังวล
                <br />
                คุณสามารถเปลี่ยนระดับการเรียนที่เหมาะสมกับคุณได้อีกครั้งภายในเวลา
                7 วัน
                <br />
...
.text-stroke {
  color: #fff;
  font-size: 26px;
  text-shadow: rgb(81, 42, 8) 3px 0px 0px,
    rgb(81, 42, 8) 2.83487px 0.981584px 0px,
    rgb(81, 42, 8) 2.35766px 1.85511px 0px,
    rgb(81, 42, 8) 1.62091px 2.52441px 0px,
    rgb(81, 42, 8) 0.705713px 2.91581px 0px,
    rgb(81, 42, 8) -0.287171px 2.98622px 0px,
    rgb(81, 42, 8) -1.24844px 2.72789px 0px,
    rgb(81, 42, 8) -2.07227px 2.16926px 0px,
    rgb(81, 42, 8) -2.66798px 1.37182px 0px,
    rgb(81, 42, 8) -2.96998px 0.42336px 0px,
    rgb(81, 42, 8) -2.94502px -0.571704px 0px,
    rgb(81, 42, 8) -2.59586px -1.50383px 0px,
    rgb(81, 42, 8) -1.96093px -2.27041px 0px,
    rgb(81, 42, 8) -1.11013px -2.78704px 0px,
    rgb(81, 42, 8) -0.137119px -2.99686px 0px,
    rgb(81, 42, 8) 0.850987px -2.87677px 0px,
    rgb(81, 42, 8) 1.74541px -2.43999px 0px,
    rgb(81, 42, 8) 2.44769px -1.73459px 0px,
