      ...
      <q-card class="transparent shadow-0">
        <q-card-section class="no-padding">
          <div class="row justify-center">
            ...
            >
              <div class="relative-position" style="top: 50%">
                <q-img
          ...
          <div
            align="center"
            class="q-pa-md row justify-center q-pt-lg"
            :class="isCorrectAnswer ? 'bg-correct' : 'bg-incorrect'"
            style="min-height: 120px; max-height: fit-content"
          >
            <div class="row q-pt-lg" style="max-width: 360px; width: 100%">
              <div class="col-1 q-py-md" style="width: 70px" align="center">
                <q-icon
                  size="50px"
                  color="green"
                  style="color: #58cc02"
              ...
              <q-space></q-space>
              <div class="col-12 q-pa-sm self-center" align="center">
                <q-btn
